...
import {sidebarAccountAdminConfig } from './config/sidebarAccountAdminConfig';
...
export default function SidebarAccountAdmin(props) {
         ...
         <div className="sidebarAccount__wrapper">
            <div className="sidebarAccount__wrapper__userProfile">
               ...
               <div className="name">
                  ...
                  <Link className="editProfile" to={customerLink.profileAdminLink}>
                     <MdEdit />
                     <span>Sửa hồ sơ</span>
                  </Link>
               </div>
            ...
            <ul className="sidebarAccount__wrapper__list">
               {sidebarAccountAdminConfig.map((item) => {
                  if(item.sublist){
