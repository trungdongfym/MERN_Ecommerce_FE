import { Avatar, Checkbox, IconButton, InputAdornment, Stack, Table, TableBody, TableCell, TableContainer, TablePagination, TableRow, Tooltip, Typography } from "@mui/material";
                  ...
                  <Table>
                     ...
                     <TableBody>
                        ...
                        .map((product) => {
                           ...
                           const isDisable = importedProducts && 
                              ...
                              >
                                 <TableCell padding="checkbox">
                                    <Checkbox 
                                       ...
                                       disabled = {isDisable}
                                       onChange={(event) => handleClickCheckboxProducts(event, product)} 
                                    />
                                 </TableCell>
